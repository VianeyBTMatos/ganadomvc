      ...
      <div align = "center">
         <div style = "background-color:#333333; color:#FFFFFF; padding:6px;" ><b>Login</b></div>
            <div style = "margin:30px; width: 30%;" class="page-header" align="left">
               <form method="post">
                  <label>Correo  :</label><br/><input type="text" name="email" class="form-control" value="correo100@mail.com" required/><br /><br />
...
$url = 'http://localhost:8080/api.peopleapp.com/v1/usuarios/login/';
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
   ...
   if($contenido["usuario"]["claveApi"]){
      // variables de sesión
      session_id("nuevaSesion");
      session_start();
      $_SESSION['sesion_iniciada'] = true;
      $_SESSION['usuario'] = $contenido["usuario"]["correo"];
      $_SESSION['claveApi'] = $contenido["usuario"]["claveApi"];
